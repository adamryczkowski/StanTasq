...
def model_generator_cov(
    par_count: int = 2, nrow: int = 100
    ...
    model_code.append("   int<lower=1> nrow;")
    model_code.append("   int<lower=1> par_count;")
    model_code.append("   array[nrow] vector[par_count] rows;")
    model_code.append("}")
    model_code.append("parameters {")
    model_code.append("   vector[par_count] mu;")
    model_code.append("   cov_matrix[par_count] sigma;")
    model_code.append("}")
